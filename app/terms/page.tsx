  ...
  return (
    <div className="container px-4 py-3 md:px-8 mx-auto mt-10">
      ...
      <Text>
        ...
        subject to the prevailing law. Any use of the above terminology or other
        ...
        exchange opinions and information in certain areas of the website. AI
        Detective does not publish Comments prior to their presence on the
        website. Comments do not reflect the views and opinions of AI Detective,
        ...
        by applicable laws, AI Detective shall not be liable for the Comments or
        ...
        on this website.
        <br />
        AI Detective reserves the right to monitor all Comments and to edit or
        filter or remove any Comments which can be considered inappropriate,
      ...
      <Text>
        We employ the use of cookies. By accessing AI Detective, you agreed to
        use cookies in agreement with the AI Detective’s Privacy Policy.
        <br />
      ...
      <Text>
        ...
        necessary licenses and consents to do so. Comments do not invade any
        ...
        which is an invasion of privacy. The Comments will not be used to
        solicit or promote business or custom or present commercial activities
        or unlawful activity. You hereby grant AI Detective a non-exclusive
