...
export function Footer() {
  ...
  return (
    <div className="pointer-events-none sticky inset-x-0 bottom-0 pt-10">
      <div className="pointer-events-auto flex items-center justify-between gap-x-6 bg-white  sm:rounded-xl py-2 pl-4 pr-3.5 sm:border border-ui-tag-neutral-border sm:flex-row flex-col">
        <div>
